...
class MapUI {
  constructor() {
    ...
    this.rooms = [
      ...
      // Upper floors
      { id: 'library_east',       label: 'East Library',    x: 580, y: 155, accessible: true },
      { id: 'nathaniel_room',     label: "Nathaniel's Room", x: 240, y: 155, accessible: false, lockedFlag: 'met_nathaniel' },
      // Grounds
      { id: 'carriage_house',     label: 'Carriage House',  x: 155, y: 390, accessible: true },
      { id: 'groundskeeper_shed', label: "Grdskpr's Shed",  x: 620, y: 405, accessible: false, lockedFlag: 'shed_accessed' },
      // Off-estate
      { id: 'dr_crane_office',    label: "Dr. Crane's Office", x: 700, y: 460, accessible: false, lockedFlag: 'crane_meeting_scheduled' },
      { id: 'whitmore_bank',      label: 'Whitmore Bank',   x: 760, y: 440, accessible: false, lockedFlag: 'safety_deposit_key' },
    ];
  }
  ...
  renderRoomLabels() {
    ...
    this.rooms.forEach(room => {
      const isAccessible = room.accessible || gameState.getFlag(room.lockedFlag);
