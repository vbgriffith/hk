...
const MapGenerator = (() => {
  ...
  function drawFeatureIcon(ctx, cx, cy, type, theme) {
    // Use drawn sprites from MapExtensions if available, fall back to emoji
    if (typeof MapExtensions !== 'undefined') {
      MapExtensions.drawSprite(ctx, cx, cy, type, theme);
      return;
    }
    ctx.save();
    ...
    var iconMap = {
      ...
      'Funeral Pyre':'🔥','Corpse Pile':'☠','Black Candles':'🕯',
      'Floating Orb':'◉','Arcane Circle':'⊕','Magical Apparatus':'⚗',
      'Binding Rune':'ᚱ','Crystal Pillar':'◈','Ley Line Node':'✦',
      'Ancient Stone':'🗿','Living Roots':'🌿','Mushroom Cluster':'🍄','Underground Spring':'💧',
      'Cave Crystal':'💎','Glowing Moss':'✨',
      'Grand Altar':'⛩','Holy Font':'🫙','Sacred Flame':'🔥','Reliquary':'📿',
      'Planar Rift':'🌀','Reality Crystal':'💎','Void Obelisk':'▲',
    };
