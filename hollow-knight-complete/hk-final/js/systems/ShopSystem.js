...
class ShopScreen {
  ...
  _build() {
    ...
    this._descName = this.scene.add.text(W/2,H-50,'',{fontFamily:'Cinzel',fontSize:8,color:'#d4cfc9'})
      .setScrollFactor(0).setDepth(C.LAYER_UI+12).setOrigin(0.5).setVisible(false);
    this._descText = this.scene.add.text(W/2,H-36,'',{fontFamily:'IM Fell English',fontStyle:'italic',fontSize:6,color:'#888888',wordWrap:{width:W-30},align:'center'})
      .setScrollFactor(0).setDepth(C.LAYER_UI+12).setOrigin(0.5).setVisible(false);
    this._costText = this.scene.add.text(W/2,H-16,'',{fontFamily:'Cinzel',fontSize:7,color:'#e8c84a'})
      .setScrollFactor(0).setDepth(C.LAYER_UI+12).setOrigin(0.5).setVisible(false);
    this._hint = this.scene.add.text(W/2,H-4,'[Z] Buy  [ESC] Close',{fontFamily:'Cinzel',fontSize:5,color:'#444444'})
      .setScrollFactor(0).setDepth(C.LAYER_UI+11).setOrigin(0.5).setVisible(false);
  }
...
GameScene.prototype._showCredits = function() {
  ...
  const lines = [
    { text: 'HOLLOW KNIGHT',         style: { fontFamily:'Cinzel', fontSize:16, color:'#d4cfc9', letterSpacing:8 } },
    { text: 'Web Clone',             style: { fontFamily:'Cinzel', fontSize:8,  color:'#888888' } },
    { text: '',                      style: {} },
    { text: 'Built with Phaser 3',   style: { fontFamily:'IM Fell English', fontSize:7, color:'#666666' } },
    { text: 'All content original',  style: { fontFamily:'IM Fell English', fontSize:7, color:'#666666' } },
    { text: '',                      style: {} },
    { text: 'Original game by',      style: { fontFamily:'Cinzel', fontSize:6, color:'#888888' } },
    { text: 'Team Cherry',           style: { fontFamily:'Cinzel', fontSize:9, color:'#5ae3e3' } },
    { text: '',                      style: {} },
    { text: 'Thank you for playing', style: { fontFamily:'IM Fell English', fontStyle:'italic', fontSize:8, color:'#d4cfc9' } },
  ];
