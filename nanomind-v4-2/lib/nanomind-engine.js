...
class NanoMindEngine {
  ...
  async load(json) {
    ...
    console.log(`[NanoMind v5.0] ${json.n_samples} entries, vocab=${json.n_features}`);
    this.ready = true;
  }
  ...
  _fallback(text) {
    ...
    if (m.mood === 'negative') return [
      ...
      "That sounds really hard. Keep talking.",
    ...
    return [
      ...
      "Oof. Tell me more.",
      "What do you mean?",
      "That's real. What else?",
      "Okay I want to understand this better.",
      "Tell me everything.",
      "I'm listening.",
    ][m.turns % 15];
  }
