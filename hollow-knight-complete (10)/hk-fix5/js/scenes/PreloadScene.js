...
class PreloadScene extends Phaser.Scene {
  ...
  create() {
    ...
    // NOTE: AnimationManager.registerAll() and scene.start() are called
    // by the Phase II patch below, AFTER all P2+P3 textures are also generated.
  }
...
PreloadScene.prototype.create = function() {
  // Generate Phase I textures (but defer animation registration)
  this._generateAllTextures();
  // Generate Phase II textures
  this._genPhase2Textures();
  // Now register ALL animations (P1 + P2 + P3 which _genPhase2Textures chains into)
