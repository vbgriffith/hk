...
PreloadScene.prototype._genGreatHopper = function() {
  this._simpleEnemySheet('great_hopper', 28, 22, 3, (ctx, w, h, row, f, t) => {
...
PreloadScene.prototype._genFungoon = function() {
  this._simpleEnemySheet('fungoon', 22, 18, 3, (ctx, w, h, row, f, t) => {
    const cx = w/2, cy = h*0.6;
...
PreloadScene.prototype._genShrumalOgre = function() {
  this._simpleEnemySheet('shrumal_ogre', 36, 38, 3, (ctx, w, h, row, f, t) => {
...
PreloadScene.prototype._genMantisWarrior = function() {
  this._simpleEnemySheet('mantis_warrior', 22, 36, 3, (ctx, w, h, row, f, t) => {
    const cx = w/2, cy = h*0.5;
...
PreloadScene.prototype._genMantisLords = function() {
  this._simpleEnemySheet('mantis_lords', 28, 48, 5, (ctx, w, h, row, f, t) => {
    const cx = w/2, cy = h*0.5;
...
PreloadScene.prototype._genPaleLurker = function() {
  this._simpleEnemySheet('pale_lurker', 20, 20, 2, (ctx, w, h, row, f, t) => {
...
PreloadScene.prototype._genUumuu = function() {
  this._simpleEnemySheet('uumuu', 46, 46, 3, (ctx, w, h, row, f, t) => {
...
PreloadScene.prototype._genDungDefender = function() {
  this._simpleEnemySheet('dung_defender', 40, 36, 3, (ctx, w, h, row, f, t) => {
    const cx=w/2,cy=h*0.55;
...
PreloadScene.prototype._genLurienWatcher = function() {
  this._simpleEnemySheet('lurien_watcher', 30, 48, 3, (ctx, w, h, row, f, t) => {
...
PreloadScene.prototype._genSoulMaster = function() {
  this._simpleEnemySheet('soul_master', 30, 52, 5, (ctx, w, h, row, f, t) => {
...
PreloadScene.prototype._genHKBoss = function() {
  this._simpleEnemySheet('hollow_knight_boss', 44, 58, 7, (ctx, w, h, row, f, t) => {
...
PreloadScene.prototype._genRadiance = function() {
  this._simpleEnemySheet('radiance', 52, 52, 3, (ctx, w, h, row, f, t) => {
