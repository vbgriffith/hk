...
class MainMenuScene extends Phaser.Scene {
  ...
  _showCredits() {
    ...
    const lines = [
      { text: 'HOLLOW KNIGHT — Web Clone', style: { fontFamily: 'Cinzel', fontSize: 27, color: '#d4cfc9' } },
      { text: '', style: {} },
      { text: 'Original game by Team Cherry', style: { fontFamily: 'IM Fell English', fontStyle: 'italic', fontSize: 21, color: '#888888' } },
      { text: '', style: {} },
      { text: 'Phase I — Forgotten Crossroads', style: { fontFamily: 'Cinzel', fontSize: 21, color: '#5ae3e3' } },
      { text: 'Powered by Phaser 3', style: { fontFamily: 'IM Fell English', fontSize: 18, color: '#555566' } },
      { text: '', style: {} },
      { text: '[ESC] to close', style: { fontFamily: 'Cinzel', fontSize: 18, color: '#555555' } },
    ];
