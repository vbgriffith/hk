...
Phase 3 completes **Layer 1 (PILGRIM / Veldenmoor)**:

- ✅ Raven sequence puzzle — 5 ravens on lamp posts, click order is Pi (3,1,4,1,5)
- ✅ Order hints appear near each raven after Oswin gives the hint
- ✅ Workshop gate — locked until sequence solved, glows and opens on completion
- ✅ Full keyboard dialogue — Space/Enter to advance, ↑↓ to navigate choices, E to interact
- ✅ Proximity prompt system — interactable label appears when player is near
- ✅ Coin inventory item — appears in corner after first Oswin puzzle
- ✅ Corruption bleed into Layer 1 — sky darkens, sun dims, cobblestones grey, Oswin degrades
- ✅ First-visit Maren note about Veldenmoor
- ✅ Three bug fixes: ForumRenderer load order, websites_extra.js crash, terminal password state
...
| 3 | ✅ Complete | Layer 1 fully playable — ravens, sequence puzzle, gate, keyboard dialogue |
| 4 | 🔜 Next | Layer 2 interactive (file tree clickable, canary puzzle) |
