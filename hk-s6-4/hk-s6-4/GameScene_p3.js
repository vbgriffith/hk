...
GameScene.prototype._buildSaveData = function() {
  ...
  if (this._dreamers) {
    try {
      const dreamerData = this._dreamers.toSaveData();
      if (dreamerData && typeof dreamerData === 'object') {
        Object.assign(base, dreamerData);
      }
    } catch (e) {
      console.warn('DreamerSystem.toSaveData() failed:', e);
    }
  }
  return base;
};
