...
(function (root) {
  ...
  const STYLES = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #computed-pane { flex: 1; min-height: 0; border-bottom: 1px solid var(--border); overflow-y: auto; scrollbar-width: thin; scrollbar-color: var(--border) transparent; }
    #boxmodel-pane { flex-shrink: 0; overflow-y: auto; scrollbar-width: thin; scrollbar-color: var(--border) transparent; }
    ...
    #add-rule-row {
      ...
      background: var(--bg1); position: sticky; bottom: 0;
    }
    #add-prop, #add-val {
      ...
      <div id="insp-body">
        ...
        <div id="styles-split">
          ...
          <div id="boxmodel-pane">
            <div class="pane-hdr">Box Model</div>
