...
const Generator = (() => {
  ...
  function generateNPCs(base, config) {
    ...
    const firstNames = ["Aldara","Caius","Mirela","Thorvald","Zephyrine","Kasimir","Lirien","Ozren","Fennick","Tarasha","Ileth","Rogan","Solvey","Nadir","Corazon"];
    const lastNames  = ["Voss","Kast","Vex","Brightmantle","the Unbroken","of the North Wind","Dunmore","Ashcroft","Silversong","Rein","Coldwater","Dunwall","the Forgotten","Mirepoix","Graystone"];
