...
const BrowserEngine = (function () {
  ...
  const URL_REGISTRY = {
    ...
    'halverstrom.org':       { site: 'Halverstrom',     requiresFlag: 'halverstrom_injected', anomalous: true },
    'substrate-archive.net': { site: 'SubstrateArchive',requiresFlag: 'substrate_injected',  anomalous: true },
