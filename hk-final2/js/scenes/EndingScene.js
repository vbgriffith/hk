...
class EndingScene extends Phaser.Scene {
  ...
  _buildSealed() {
    ...
    this.add.text(W/2, H*0.3, 'THE HOLLOW KNIGHT', {
      fontFamily:'Cinzel',fontSize:11,color:'#888888',letterSpacing:8,
    }).setScrollFactor(0).setOrigin(0.5).setAlpha(0);

    this.add.text(W/2, H*0.45, 'A new seal is made.', {
      fontFamily:'IM Fell English',fontStyle:'italic',fontSize:8,color:'#666666',
    }).setScrollFactor(0).setOrigin(0.5).setAlpha(0);

    this.add.text(W/2, H*0.55, 'Hallownest endures.', {
      fontFamily:'IM Fell English',fontStyle:'italic',fontSize:8,color:'#555555',
    }).setScrollFactor(0).setOrigin(0.5).setAlpha(0);

    this.add.text(W/2, H*0.68, 'SEALED', {
      fontFamily:'Cinzel',fontSize:9,color:'#4400aa',letterSpacing:12,
    }).setScrollFactor(0).setOrigin(0.5).setAlpha(0);
  ...
  _buildDreamNoMore() {
    ...
    const lines = [
      { y:0.25, text:'The light is gone.', size:10, color:'#ccbbaa', delay:3500 },
      { y:0.38, text:'For the first time in an age,', size:7, color:'#998877', delay:4500 },
      { y:0.47, text:'Hallownest is quiet.', size:7, color:'#998877', delay:5200 },
      { y:0.62, text:'DREAM NO MORE', size:10, color:'#e8d090', delay:6500, spacing:10 },
    ];
...
class CreditsScene extends Phaser.Scene {
  ...
  create() {
    ...
    const creditsText = [
      { text:'HOLLOW KNIGHT',       size:14, color:'#d4cfc9', spacing:10, gap:20 },
      { text:'Web Clone',           size:8,  color:'#666666', gap:24 },
      { text:'DESIGN & CODE',       size:7,  color:'#5ae3e3', gap:6 },
      { text:'Built with Claude',   size:6,  color:'#888888', gap:18 },
      { text:'ENGINE',              size:7,  color:'#5ae3e3', gap:6 },
      { text:'Phaser 3.60',         size:6,  color:'#888888', gap:18 },
      { text:'ORIGINAL GAME',       size:7,  color:'#5ae3e3', gap:6 },
      { text:'Team Cherry',         size:6,  color:'#888888', gap:4 },
      { text:'Ari Gibson & William Pellen', size:6, color:'#666666', gap:18 },
      { text:'MUSIC',               size:7,  color:'#5ae3e3', gap:6 },
      { text:'Procedural Web Audio API',size:6,color:'#888888', gap:18 },
      { text:'AREAS IMPLEMENTED',   size:7,  color:'#5ae3e3', gap:6 },
      { text:'Forgotten Crossroads',size:6,  color:'#888888', gap:4 },
      { text:'Greenpath',           size:6,  color:'#888888', gap:4 },
      { text:'City of Tears',       size:6,  color:'#888888', gap:4 },
      { text:'Soul Sanctum',        size:6,  color:'#888888', gap:4 },
      { text:'Fungal Wastes',       size:6,  color:'#888888', gap:4 },
      { text:'Mantis Village',      size:6,  color:'#888888', gap:4 },
      { text:'Ancient Basin',       size:6,  color:'#888888', gap:4 },
      { text:'The Abyss',           size:6,  color:'#888888', gap:18 },
      { text:'BOSSES',              size:7,  color:'#5ae3e3', gap:6 },
      { text:'False Knight  ·  Gruz Mother  ·  Vengefly King', size:6, color:'#888888', gap:4 },
      { text:'Soul Master  ·  Mantis Lords', size:6, color:'#888888', gap:4 },
      { text:'Hollow Knight  ·  The Radiance', size:6, color:'#888888', gap:18 },
      { text:'Thank you for playing.', size:8, color:'#d4cfc9', gap:20 },
      { text:'— Press any key to return to menu —', size:5, color:'#444444', gap:0 },
    ];
