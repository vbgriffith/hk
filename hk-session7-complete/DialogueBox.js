...
class MapScreen {
  ...
  _drawMap() {
    ...
    // Complete world map layout (44 total rooms)
    const layout = {
      ...
      // Crystal Peak
      crystal_peak_entrance:{ mx: CX + 50,  my: CY - 120 },
      crystal_peak_main:    { mx: CX + 100, my: CY - 120 },
      
      // Resting Grounds
      resting_grounds_entrance: { mx: CX + 100, my: CY - 160 },
      ...
      // Queen's Gardens
      queens_gardens_entrance: { mx: CX - 100, my: CY - 40 },
      queens_gardens_main:  { mx: CX - 150, my: CY - 40 },
      
      // Fog Canyon
      fog_canyon_entrance:  { mx: CX - 100, my: CY },
      fog_canyon_main:      { mx: CX - 150, my: CY },
      teacher_archives:     { mx: CX - 150, my: CY - 40 },
      uumuu_arena:          { mx: CX - 150, my: CY - 80 },
      ...
      // Mantis Village (expanded)
      mantis_village_entrance: { mx: CX + 150, my: CY + 40 },
      mantis_village_main:  { mx: CX + 200, my: CY + 40 },
      mantis_outskirts:     { mx: CX + 250, my: CY + 40 },
      ...
      // Kingdom's Edge
      kingdoms_edge_entrance:{ mx: CX + 50, my: CY + 80 },
      kingdoms_edge_main:   { mx: CX + 100, my: CY + 80 },
      
      // Ancient Basin (expanded)
      ancient_basin_entrance:{ mx: CX + 150, my: CY + 120 },
      basin_west:           { mx: CX + 100, my: CY + 120 },
      basin_depths:         { mx: CX + 150, my: CY + 160 },
      
      // The Abyss (expanded)
      abyss_entrance:       { mx: CX + 150, my: CY + 200 },
      abyss_depths:         { mx: CX + 150, my: CY + 240 },
      abyss_void_heart:     { mx: CX + 150, my: CY + 280 },
      
      // Dreamers
      dreamer_monomon:      { mx: CX - 200, my: CY - 80 },
